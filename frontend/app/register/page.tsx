      ...
      <div className="relative w-full max-w-[400px] z-10">
        <div className="bg-[#0F1A1A]/80 backdrop-blur-xl border border-[#38F0B0]/20 rounded-3xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.5)] shadow-[#38F0B0]/5 transition-all duration-500 hover:border-[#38F0B0]/40">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-[#A3C2B2] text-sm font-medium">Create your account to start analyzing.</p>
          </div>

          {error && <div className="mb-4 p-3 bg-red-500/10 border border-red-500/30 rounded-xl text-[#ff5c5c] text-sm text-center font-medium">{error}</div>}

          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-[#AACEC0] text-xs font-semibold uppercase tracking-wider">Full Name</label>
              <input 
                type="text" 
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[#AACEC0] text-xs font-semibold uppercase tracking-wider">Confirm Password</label>
              <input 
                type="password" 
                placeholder="••••••••"
